...
const panel: Session = {
  time: '16:15 – 17:00',
  title: 'Panel de cierre: comunidad tech en Ecuador · Auditorio A',
  isBreak: true,
};
...
const talks: Record<TrackId, Talk[]> = {
  Web: [
    [
      '10:15 – 11:00',
      'Signals, server components y el fin del re-render innecesario',
      'María José Vera / Staff Engineer, Kushki',
    ],
    [
      '11:15 – 12:00',
      'Accesibilidad no es un plugin: WCAG en equipos reales',
      'Gabriela Ríos / Frontend Lead, Tuti',
    ],
  ...
  Mobile: [
    [
      '10:15 – 11:00',
      'Compose Multiplatform en producción: lo que nadie te cuenta',
      'Andrés Loor / Google Developer Expert, Android',
    ],
    [
      '11:15 – 12:00',
      'Rendimiento en Android: del jank al 60 fps',
      'Luis Fernando Zambrano / Android Engineer, Yummy',
    ],
  ...
  Cloud: [
    [
      '10:15 – 11:00',
      'Del monolito a Cloud Run sin apagar el negocio',
      'Kevin Paredes / Cloud Architect, Banco Guayaquil',
    ],
    [
      '11:15 – 12:00',
      'FinOps para startups: la factura de GCP que sí entiendes',
      'Xavier Mendoza / Founder, Nube Labs',
    ],
  ...
  AI: [
    [
      '10:15 – 11:00',
      'Gemini en tu backend: agentes que sí llegan a producción',
      'Daniela Cedeño / ML Engineer, Datil',
    ],
    [
      '11:15 – 12:00',
      'RAG bien hecho: embeddings, evaluación y latencia',
      'Paola Andrade / Data Scientist, ESPOL',
    ],
...
export const schedule: TrackSchedule[] = tracks.map((track) => {
  const [t1, t2, t3, t4] = talks[track.id].map(([time, title, who]): Session => ({
    time,
    title,
    who: who ?? TBC,
